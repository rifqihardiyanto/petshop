          ...
          <div class="col-lg-12 mb-5">
            <div class="single-blog-item">
              <div class="blog-item-content">
                ...
                <h2 class="mb-4 text-md"><a href="index.php?page=3">Pembayaran Penitipan</a></h2>

                <form action="controller/uploadPenitipan.php" method="post" enctype="multipart/form-data">

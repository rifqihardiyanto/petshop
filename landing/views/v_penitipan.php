    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">Penitipan Hewan</h1>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="col-lg-12 mb-5">
            <div class="single-blog-item">
              <div class="blog-item-content">
                ...
                <h2 class="mb-4 text-md"><a href="index.php?page=1">Pendaftaran Penitipan Hewan</a></h2>
                ...
                <form action="controller/addPenitipan.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <?php $penitipan = $connect->query("SELECT * FROM tb_penitipan"); ?>
                    <select class="form-control" name="id_penitipan">
                      <?php while ($value = $penitipan->fetch_object()) { ?>
                        <option value="<?= $value->id_penitipan; ?>"><?= $value->jenis_penitipan; ?> - Rp.<?= number_format($value->harga_penitipan); ?>;-/Hari (<?php if($value->status_penitipan=='1'){ echo "Dapat Makan"; } else { echo "Tidak Ada Makan"; } ?>)</option>
                      <?php  } ?>
                    </select>
                  </div>

                  <div class="form-group">
                    <label for="exampleFormControlInput1">Tanggal Penitipan</label>
                    <input type="date" min="<?= date('Y-m-d'); ?>" class="form-control" name="mulai" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Tanggal Diambil</label>
                    <input type="date" class="form-control" min="<?= date('Y-m-d'); ?>" name="selesai" required>
                  </div>
      ...
      <div class="col-lg-4">
        <div class="sidebar-wrap pl-lg-4 mt-5 mt-lg-0">
          <div class="sidebar-widget schedule-widget mb-3">
            <h5 class="mb-4">Jadwal Penitipan Hewan</h5>

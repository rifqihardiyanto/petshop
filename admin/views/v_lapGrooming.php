          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                <?php
                $no = 0;
                $setGrooming = $connect->query("SELECT * FROM tb_dt_grooming WHERE status_diambil='1' ORDER BY status_diambil DESC");
                      ...
                      <td>
                        <?php if ($gro->jenis_bayar == '0') { ?>
                          <?php if ($gro->status_diambil == '1'): ?>
                            <span class="badge badge-success">Selesai</span>
                          <?php else: ?>
                            <a href="controller/penitipan/updateAmbil.php?id=<?= $gro->id_dt_grooming; ?>" class="btn btn-info btn-sm">Diambil</a>
                          <?php endif; ?>
                        <?php } else { ?>
                          <?php if ($gro->status_diambil == '1'): ?>
                            <span class="badge badge-success">Selesai</span>
                          <?php else: ?>
                            <a href="controller/penitipan/updateAmbil.php?id=<?= $gro->id_dt_grooming; ?>" class="btn btn-info btn-sm">Diambil</a>
                            <a href="controller/penitipan/updateLunas.php?id=<?= $gro->id_dt_grooming; ?>" class="btn btn-success btn-sm">Lunas</a>
                          <?php endif; ?>
                        <?php } ?>
                      </td>
                    </tr>

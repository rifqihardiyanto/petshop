          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                <?php
                $no = 0;
                $setPenitipan = $connect->query("SELECT * FROM tb_dt_penitipan WHERE status_diambil='0' ORDER BY status_diambil DESC");
                while ($pen = $setPenitipan->fetch_object()) { ?>
                  ...
                  <?php else: ?>
                    <tr>
                      ...
                      <td>
                        <?= AesCtr::encrypt($pen->alamat_ambil, $gro->aes_key, 128); ?>
                      </td>
